(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            let prodSwiper = new core(".product__slider", {
            ...
            const filterButtons = document.querySelectorAll(".product__filter-item");
            const productSlider = document.querySelector(".product__slider");
            function filterSlides(category) {
                productSlider.querySelectorAll(".product__slide").forEach((slide => {
                    if ("all" === category || slide.getAttribute("data-filter") === category) slide.style.display = "block"; else slide.style.display = "none";
                }));
                prodSwiper.update();
            }
